...
class WeightAddActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.deptAddTitle.text = "체중"
        binding.texttime.text ="시간"
        binding.textC.text = "체중"
        ...
        binding.addbutton.setOnClickListener {
            CoroutineScope(Dispatchers.IO).launch {
                ...
                try{
                    healthConnectManager.writeWeightInput(value, startTime)

                    CoroutineScope(Dispatchers.Main).launch {
                        Toast.makeText(this@WeightAddActivity, "Successfully insert records", Toast.LENGTH_SHORT).show()
                    }
                    finish()
                }
                catch (e: Exception) {
                    ...
                    CoroutineScope(Dispatchers.Main).launch {
                        Toast.makeText(this@WeightAddActivity, e.message.toString(), Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
